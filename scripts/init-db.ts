  ...
  const recipes = [
    {
      ...
      cuisine: 'italian',
      tags: ['vegetarian', 'creamy', 'comfort'] as any,
      categories: ['main-dish', 'rice'] as any,
      ingredients: [
    ...
    },
    {
      ...
      instructions: [
        ...
        'Mélanger la tomate avec la vinaigrette',
      ...
      difficulty: 'beginner',
      cuisine: 'french',
      tags: ['salad', 'quick', 'healthy'] as any,
      categories: ['starter', 'salad'] as any,
      ingredients: [
        { ingredientId: await getIngredientId('Tomate'), quantity: 200, unit: 'g' },
